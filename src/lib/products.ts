...
export const PRODUCTS: Product[] = [
  // ── BAHAMAS ────────────────────────────────────────────────
  {
    ...
    image: IMG("bahamas-cafe-cafe/2k-v2/1.png"),
    gallery: [
      IMG("bahamas-cafe-cafe/2k-v2/1.png"),
      IMG("bahamas-cafe-cafe/2k-v2/2.png"),
      IMG("bahamas-cafe-cafe/2k-v2/3.png"),
      IMG("bahamas-cafe-cafe/2k-v2/4.png"),
    ],
    angleCount: 4,
    originalPrice: 179.9,
  },
  {
    ...
    image: IMG("bahamas-preto-azul/2k-v2/keeus-4511-bahamas-preto-azul-bco-pto-1.png"),
    gallery: [
      IMG("bahamas-preto-azul/2k-v2/keeus-4511-bahamas-preto-azul-bco-pto-1.png"),
      IMG("bahamas-preto-azul/2k-v2/keeus-4511-bahamas-preto-azul-bco-pto-2.png"),
      IMG("bahamas-preto-azul/2k-v2/keeus-4511-bahamas-preto-azul-bco-pto-34511-bahamas-cafe-cafe-bco-laranja-3.png"),
      IMG("bahamas-preto-azul/2k-v2/keeus-4511-bahamas-preto-azul-bco-pto-4-bahamas-cafe-cafe-bco-laranja-4.png"),
    ],
    angleCount: 4,
    originalPrice: 179.9,
  },
  {
    ...
    image: IMG("bahamas-preto-preto/2k-v2/1.png"),
    gallery: [
      IMG("bahamas-preto-preto/2k-v2/1.png"),
      IMG("bahamas-preto-preto/2k-v2/2.png"),
      IMG("bahamas-preto-preto/2k-v2/3.png"),
      IMG("bahamas-preto-preto/2k-v2/4.png"),
    ],
    angleCount: 4,
  },
  ...
  // ── MALIBU ──────────────────────────────────────────────────
  {
    ...
    image: IMG("malibu-cafe-cafe/2k-v2/1.png"),
    gallery: [
      IMG("malibu-cafe-cafe/2k-v2/1.png"),
      IMG("malibu-cafe-cafe/2k-v2/2.png"),
      IMG("malibu-cafe-cafe/2k-v2/3.png"),
      IMG("malibu-cafe-cafe/2k-v2/4.png"),
    ],
    angleCount: 4,
    originalPrice: 149.9,
  },
  {
    ...
    image: IMG("malibu-preto-preto/2k-v2/1.png"),
    gallery: [
      IMG("malibu-preto-preto/2k-v2/1.png"),
      IMG("malibu-preto-preto/2k-v2/2.png"),
      IMG("malibu-preto-preto/2k-v2/3.png"),
      IMG("malibu-preto-preto/2k-v2/4.png"),
    ],
    angleCount: 4,
  },
  {
    ...
    image: IMG("malibu-mel-cafe/2k-v2/1.png"),
    gallery: [
      IMG("malibu-mel-cafe/2k-v2/1.png"),
      IMG("malibu-mel-cafe/2k-v2/2.png"),
      IMG("malibu-mel-cafe/2k-v2/3.png"),
      IMG("malibu-mel-cafe/2k-v2/4.png"),
    ],
    angleCount: 4,
    originalPrice: 149.9,
  },
  {
    ...
    image: IMG("malibu-cafe-cafe-meli/2k-v2/1.png"),
    gallery: [
      IMG("malibu-cafe-cafe-meli/2k-v2/1.png"),
      IMG("malibu-cafe-cafe-meli/2k-v2/2.png"),
      IMG("malibu-cafe-cafe-meli/2k-v2/3.png"),
      IMG("malibu-cafe-cafe-meli/2k-v2/4.png"),
    ],
    angleCount: 4,
    originalPrice: 159.9,
  },
  {
    ...
    image: IMG("malibu-mel-cafe-meli/2k-v2/1.png"),
    gallery: [
      IMG("malibu-mel-cafe-meli/2k-v2/1.png"),
      IMG("malibu-mel-cafe-meli/2k-v2/2.png"),
      IMG("malibu-mel-cafe-meli/2k-v2/3.png"),
      IMG("malibu-mel-cafe-meli/2k-v2/4.png"),
    ],
    angleCount: 4,
    originalPrice: 159.9,
  },
  ...
  // ── TOLEDO ──────────────────────────────────────────────────
  {
    ...
    image: IMG("toledo-cafe-cafe/2k-v2/1.png"),
    gallery: [
      IMG("toledo-cafe-cafe/2k-v2/1.png"),
      IMG("toledo-cafe-cafe/2k-v2/2.png"),
      IMG("toledo-cafe-cafe/2k-v2/3.png"),
      IMG("toledo-cafe-cafe/2k-v2/4.png"),
    ],
    angleCount: 4,
    originalPrice: 199.9,
  },
  {
    ...
    image: IMG("toledo-preto-laranja/2k-v2/1.png"),
    gallery: [
      IMG("toledo-preto-laranja/2k-v2/1.png"),
      IMG("toledo-preto-laranja/2k-v2/2.png"),
      IMG("toledo-preto-laranja/2k-v2/3.png"),
      IMG("toledo-preto-laranja/2k-v2/4.png"),
    ],
    angleCount: 4,
    originalPrice: 219.9,
  },
  {
    ...
    image: IMG("toledo-preto-preto/2k-v2/1.png"),
    gallery: [
      IMG("toledo-preto-preto/2k-v2/1.png"),
      IMG("toledo-preto-preto/2k-v2/2.png"),
      IMG("toledo-preto-preto/2k-v2/3.png"),
      IMG("toledo-preto-preto/2k-v2/4.png"),
    ],
    angleCount: 4,
  },

      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 md:grid-cols-[1.25fr_1fr_1fr] md:px-8">
        <div>
          <Image
            ...
            width={110}
            height={88}
            className="h-auto w-24 rounded-xl bg-white p-2"
          />
          <p className="mt-5 max-w-sm text-sm leading-7 text-white/65">
            Keeus vende slides e chinelos de dedo com fotos reais, numeração clara e pagamento via
            Pix ou cartão. Frete cotado pelo CEP no produto e no checkout.
          </p>
          ...
          <Link
            href="/sobre"
            className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-[#ff8a55] hover:text-white"
          >
      ...
      <div className="border-y border-white/10">
        <div className="mx-auto grid max-w-7xl gap-5 px-6 py-7 sm:grid-cols-3 md:px-8">
          <div className="flex items-center gap-3">
            <Ruler className="text-[#ff8a55]" size={22} />
            <div>
              <p className="text-sm font-semibold">Tamanho primeiro</p>
              <p className="text-xs text-white/50">Escolha antes de adicionar</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <RotateCcw className="text-[#ff8a55]" size={22} />
            <div>
              <p className="text-sm font-semibold">
                <Link href="/trocas" className="hover:text-white">
                  Trocas com regras
                </Link>
              </p>
              <p className="text-xs text-white/50">Leia antes de fechar o pedido</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <ShieldCheck className="text-[#ff8a55]" size={22} />
            <div>
              <p className="text-sm font-semibold">Pix e cartão</p>
              <p className="text-xs text-white/50">Pago só após confirmação</p>
            </div>
          </div>
        </div>
      </div>

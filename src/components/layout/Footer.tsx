    ...
    <footer className="border-t border-border bg-[#171512] text-white">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 md:grid-cols-[1.25fr_1fr_1fr] md:px-8">
        <div>
          ...
          <p className="mt-5 max-w-sm text-sm leading-7 text-white/65">
            Slides e chinelos de dedo Keeus apresentados com fotos reais, informações objetivas e escolha de tamanho antes da sacola.
          </p>
      ...
      <div className="border-y border-white/10">
        <div className="mx-auto grid max-w-7xl gap-5 px-6 py-7 sm:grid-cols-3 md:px-8">
          ...
          <div className="flex items-center gap-3"><RotateCcw className="text-[#ff8a55]" size={22} /><div><p className="text-sm font-semibold">Política transparente</p><p className="text-xs text-white/50">Consulte regras de troca</p></div></div>
          <div className="flex items-center gap-3"><ShieldCheck className="text-[#ff8a55]" size={22} /><div><p className="text-sm font-semibold">Dados protegidos</p><p className="text-xs text-white/50">Consulte a privacidade</p></div></div>
        </div>
      </div>
